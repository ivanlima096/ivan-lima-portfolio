...
export default function SkillBar() {
  ...
  return (
    <section className="mt-24 -mb-1 scrolling-text-container w-[100vw] h-[7rem] bg-black md:mt-40 lg:mt-96 xl:mt-8 text-white flex items-center justify-center border-none">
