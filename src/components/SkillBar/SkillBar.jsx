...
export default function SkillBar() {
  ...
  return (
    <section className="mt-20 mb-5 min-[400px]:mt-2 sm:mt-1 scrolling-text-container w-[100vw] h-[7rem] bg-black md:my-40 lg:mt-96 xl:mt-8 text-white flex items-center justify-center">
