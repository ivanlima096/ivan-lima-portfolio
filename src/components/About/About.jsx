...
export default function About() {
  return (
    <section id="sobre" className="grid grid-cols-1 xl:grid-cols-2 h-[100vh] w-[100vw]">
      ...
      <div className="rightSide w-100% h-[80%] py-10 px-4 font-semibold mx-12 text-md md:text-xl lg:text-3xl">
        ...
        <div className="flex items-center justify-center gap-10 mt-10 xl:mt-32 md:text-3xl sm:text-2xl">
          ...
          <Button text={`Ver CV`} color="black" textColor="white" icon={<BsDownload />} />
